...
const StepColumn = ({ number, title, description, colorClass, numberColor, icon: Icon }: any) => {
  return (
    <div className={`flex-1 min-h-[500px] md:min-h-[400px] lg:min-h-[600px] p-8 md:p-5 lg:p-12 flex flex-col border-r border-zinc-100 dark:border-darkBorder last:border-0 transition-all duration-700 ease-out group hover:bg-white dark:hover:bg-darkCard hover:z-10 hover:shadow-[0_40px_100px_-20px_rgba(226,255,0,0.15)] hover:scale-[1.02] cursor-default ${colorClass}`}>
      
      {/* Visual Indicator: Background Number */}
      <div className="h-24 md:h-20 lg:h-32 flex items-end mb-6 md:mb-4 lg:mb-8">
        <div className={`text-[80px] md:text-[60px] lg:text-[120px] font-black select-none tracking-tighter transition-all duration-700 group-hover:translate-x-4 group-hover:scale-110 text-zinc-900 dark:text-white`}>
          {number}
        </div>
      </div>
      ...
      <div className="h-20 md:h-16 lg:h-24 flex items-center mb-10 md:mb-8 lg:mb-16 transition-transform duration-500 group-hover:translate-y-[-8px]">
        <div className="flex items-center gap-3">
          <div className={`p-3 md:p-2.5 rounded-[20px] md:rounded-[18px] lg:rounded-[24px] bg-zinc-900 dark:bg-zinc-900 shadow-sm group-hover:shadow-md transition-all duration-500`}>
            <Icon className={`w-8 h-8 md:w-7 md:h-7 lg:w-10 lg:h-10 text-oroYellow`} />
          </div>
      ...
      <div className="transition-all duration-500 group-hover:translate-y-[-4px]">
        <div className="min-h-[4rem] md:min-h-[3.5rem] flex items-start mb-4 md:mb-3 lg:mb-6">
          <h3 className="text-xl md:text-base lg:text-2xl font-black uppercase tracking-tight leading-tight text-zinc-900 dark:text-white group-hover:text-oroYellow transition-all duration-500">
            {title}
          </h3>
        </div>
        <p className="text-zinc-500 dark:text-zinc-400 text-xs md:text-[10px] lg:text-sm leading-relaxed font-medium transition-colors duration-500 group-hover:text-zinc-700 dark:group-hover:text-zinc-300">
          {description}
        </p>
      </div>
    </div>
  ...
  return (
    <section className="bg-transparent py-32 overflow-hidden reveal transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 mb-20 text-center md:text-left">
        <div className="inline-block px-5 py-2 bg-oroYellow rounded-full mb-6 flex items-center gap-2 w-fit mx-auto md:mx-0">
           <div className="w-2 h-2 rounded-full bg-zinc-900 animate-pulse shrink-0"></div>
           <span className="text-zinc-900 font-black text-[10px] tracking-widest uppercase">The Roadmap</span>
        </div>
        <h2 className="text-5xl md:text-6xl font-black text-zinc-900 dark:text-white tracking-tight">14 Days To Freedom</h2>
        <p className="text-zinc-500 dark:text-zinc-500 mt-4 max-w-xl text-lg font-medium italic opacity-70">From initial intrigue to final close—we've mapped out the exact psychological journey of your future customers.</p>
      </div>

      {/* 4-Step Roadmap Visualization */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row bg-white dark:bg-darkCard rounded-[48px] border border-zinc-100 dark:border-darkBorder overflow-hidden shadow-heavy transition-all duration-1000 items-stretch">
        <StepColumn 
          number="1"
          ...
          colorClass="bg-zinc-50/10 dark:bg-zinc-800/40"
        ...
        <StepColumn 
          ...
          colorClass="bg-zinc-50/30 dark:bg-zinc-800/60"
        ...
        <StepColumn 
          ...
          colorClass="bg-zinc-100/20 dark:bg-zinc-800/40"
        ...
        <StepColumn 
          ...
          colorClass="bg-zinc-200/10 dark:bg-zinc-800/20"
