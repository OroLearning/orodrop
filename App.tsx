...
const App: React.FC = () => {
  ...
  // Landing Page Render
  return (
    <div className="min-h-screen hero-bg bg-transparent dark:text-slate-100 transition-colors duration-300">
      ...
      <main className="pt-32 md:pt-48 pb-20">
        <header className="flex flex-col items-center text-center mb-16 px-4 reveal">
          <div className="inline-block px-5 py-2 bg-oroYellow/20 backdrop-blur-md border border-oroYellow/30 rounded-full mb-8">
             <span className="text-oroYellow font-black text-[10px] tracking-[0.2em] uppercase">The Rainfall of Revenue Has Begun</span>
          </div>
          <div className="convex-title mb-8 flex justify-center w-full">
            <h1 className="text-5xl md:text-9xl font-black text-slate-900 dark:text-white tracking-tighter leading-[1.1] md:leading-[1.1] text-center">Let Success <br /><span className="bg-oroYellow px-4 py-1 text-slate-900 italic">Rain Down.</span></h1>
          </div>
          <p className="text-xl md:text-2xl text-slate-400 dark:text-slate-500 max-w-3xl mx-auto font-medium leading-relaxed">OroDrop crafts the exact psychological narrative your brand needs.</p>
        </header>
