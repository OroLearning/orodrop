  ...
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 w-[90%] max-w-6xl z-50 bg-white/60 dark:bg-darkCard/60 backdrop-blur-xl rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.05)] border border-white/40 dark:border-darkBorder/40 px-8 py-3 flex items-center justify-between transition-colors">
      ...
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 bg-oroYellow rounded-xl flex items-center justify-center">
        ...
        <span className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Oro <span className="text-oroYellow font-extrabold">Drop</span></span>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <button 
          ...
          className="px-6 py-2.5 rounded-xl bg-slate-900 dark:bg-oroYellow text-white dark:text-slate-900 text-xs font-black uppercase tracking-widest hover:bg-oroYellow hover:text-slate-900 transition-all shadow-xl shadow-slate-200 dark:shadow-none active:scale-95"
        >
          Launch Dashboard
        </button>
      </div>
